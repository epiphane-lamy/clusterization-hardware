...
module clusterization #(
    ...
    parameter int ADDR_W       = 12,           // largeur des adresses points Xf fixé à 12 pour matcher la macro mémoire
    parameter int P_IJ_W       = 16,          // largeur des P_ij, fixed-point SIGNE
    parameter int ADDR_P_IJ_W  = 10,           // largeur des adresses P_i fixé à 10 pour matcher la macro mémoire
